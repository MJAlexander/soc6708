...
dm <- read_csv("../data/WPP2024_Life_Table_Abridged_Medium_1950-2023.csv")
di <- read_csv("../data/WPP2024_Demographic_Indicators_Medium.csv")
```

For the matrix models, we will use fertlity and mortality rates by single year of age. I've already cleaned these up (the file is in the repo).

```{r}
ds <- read_csv("../data/wpp_pop_fx_px_female.csv")
```
...
How would you convert this probability into the number of 45 women in Kenya who have lost their mother (say, in 2023)?
